...
class ProductService extends IProductService {
  ...
  Future<List<ProductToDisplay>> getByCategory(String category) async{
    ...
    return rawProducts.map((product) => ProductToDisplay(id: product.id.toString(), name: product.title!, category: product.category!, imageUrl: product.image!, price: product.price!.toInt())).toList();
  }
}
